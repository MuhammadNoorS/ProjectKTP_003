 ...
 */
package uno.jogja.project.ktp.coba;
...
import uno.jogja.project.ktp.coba.exceptions.NonexistentEntityException;
import uno.jogja.project.ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("uno.jogja_project.ktp_jar_0.0.1-SNAPSHOTPU");
